  ...
  return (
    ...
    <div className='signup-container w-75 shadow-lg mx-auto mt-5 d-flex  flex-row-reverse justify-content-center border rounded-4  '>
      <div className='signup-container-left w-50   d-flex justify-content-center'>
        ...
        <form className='form m-auto' onSubmit={handleSignin}>
          <h1>Login</h1>
          <i className='bx bxs-user'></i><input type='email'  placeholder=' Your Email ' ref={email} className='abc outline-none outline-offset-none .shadow-none border-top-0  border-start-0 border-end-0 m-lg-2   ' />
          
          <div>   <i className='bx bx-lock-alt'></i><input type='password' placeholder='Your Password' ref={password} className='abc border-top-0  border-start-0 border-end-0  m-lg-2' /></div>
          ...
          <div>
        <h5 className='h mt-3'>or login with <i className='bx bxl-facebook-square mx-1 ' style={{color:'#001e74'}}  ></i> <i class='bx bxl-twitter' style={{color:'rgba(65,142,210,0.55)'}} ></i> <i class='bx bxl-google-plus-circle' style={{color:'#a81816'}}  ></i></h5> 
      </div>
        </form>
